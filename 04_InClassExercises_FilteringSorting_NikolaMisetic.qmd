...
# I first filtered the data by NO impeachment votes, then had that data arranged by bachelor's percentage
...
# I used the same code for Question 7, followed by filtering for bachelor's percentages below the national average
...
# I created a pipe where I first filtered by state, then filtered by NO impeachment votes
...
# I created a pipe where I filtered for YES impeachment votes and then dates with years prior to 2019. Then, I arranged the data by Clinton's highest vote percentages, specifying in the code to arrange by descent
